 ...
 *
 */
class CriteriosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_criterio_grupo' => ['type' => 'index', 'columns' => ['grupo_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_criterio_grupo' => ['type' => 'foreign', 'columns' => ['grupo_id'], 'references' => ['grupos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2015-10-25 01:05:00',
            'modified' => '2015-10-25 01:05:00',
            'status' => 1
        ],
    ];
}
