...
class CargosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_Cargo_Grupo' => ['type' => 'index', 'columns' => ['grupo_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_Cargo_Grupo' => ['type' => 'foreign', 'columns' => ['grupo_id'], 'references' => ['grupos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2015-10-25 00:57:33',
            'modified' => '2015-10-25 00:57:33',
            'status' => 1
        ],
    ];
}
